...
class MoneyDonationsExport implements FromCollection, WithHeadings, WithEvents
{
    ...
    public function collection()
    {
        return $this->records->map(fn($d) => [
            $d->id,
            $d->donor->name ?? $d->anonymous_name ?? 'Anonymous',
    ...
    {
        return ['ID', 'Donor', 'Date', 'Amount', 'Method', 'Receipt #', 'Created'];
    }
