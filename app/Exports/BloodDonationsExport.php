...
class BloodDonationsExport implements FromCollection, WithHeadings, WithEvents
{
    ...
    {
        return [
            'ID', 'Donor', 'Donation Date', 'Blood Group', 'Units',
            'Campaign', 'Location', 'Status', 'Created At', 'Updated At',
        ];
    }
