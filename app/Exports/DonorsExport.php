...
class DonorsExport implements FromCollection, WithHeadings, WithEvents
{
    ...
    public function collection()
    {
        return $this->records->map(fn($d) => [
            ...
            $d->referrer->name ?? '',
            $d->status,
            $d->last_donation_date ? $d->last_donation_date->format('d-m-Y') : '',
    ...
    {
        return [
            'ID', 'Name', 'Father Name', 'CNIC', 'Phone', 'DOB', 'Blood Group',
            'Address', 'City', 'Area', 'Student', 'University',
            'Referred By', 'Status', 'Last Donation', 'Registered',
        ];
    }
