...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'type' => 'navbar-search',
            'text' => 'Search donors, donations, requests...',
            'topnav_right' => true,
        ],
        [
        ...
        // Locale toggle is rendered via custom navbar partial
        // User menu items (appear in dropdown body)
        [
            'text' => 'My Profile',
            'route' => 'admin.profile',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'route' => 'admin.blood-donations.index',
                    'icon' => 'fas fa-fw fa-tint',
                ],
                [
                    'text' => 'Money Donations',
                    'route' => 'admin.money-donations.index',
                ...
                [
                    'text' => 'Donor Stories',
                    'route' => 'admin.donor-stories.index',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'route' => 'admin.blood-inventory.index',
